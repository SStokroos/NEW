...
class AutoRec():
    ...
    def prepare_model(self):
        ...
        V = tf.compat.v1.get_variable(name="V", initializer=tf.random.truncated_normal(shape=[self.num_items, self.hidden_neuron], mean=0, stddev=0.03), dtype=tf.float32)
...
def prepare_data(train, test, a, b):
...
user_train_set, item_train_set, user_test_set, item_test_set, num_users, num_items = prepare_data(train, test, a, b)
