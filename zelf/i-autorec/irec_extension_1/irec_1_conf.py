...
class IAutoRec():
    def __init__(self, sess, args, num_users, num_items, R, mask_R, C, train_R, train_mask_R, test_R, test_mask_R, 
                 confounder_R, num_train_ratings, num_test_ratings, user_train_set, item_train_set, 
...
def prepare_data(train, test, confounder, a, b):
    ...
    return R, mask_R, C, train_R, train_mask_R, test_R, test_mask_R, confounder_R, num_train_ratings, num_test_ratings, \
...
R, mask_R, C, train_R, train_mask_R, test_R, test_mask_R, confounder_R, num_train_ratings, num_test_ratings, \
user_train_set, item_train_set, user_test_set, item_test_set, num_users, num_items = prepare_data(train, test, confounder, a, b)
